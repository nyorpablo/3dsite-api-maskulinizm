        ...
        <div class="max-w-screen-xl px-4 py-3 mx-auto">
            <div class="flex items-center">
                <ul class="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
                    ...
                    <li>
                        <a href="{{ url('documentation') }}" class="text-gray-900 dark:text-white hover:underline @if(request()->is('documentation')) md:text-blue-700 @endif" aria-current="page">Documentation</a>
                    </li>
                    <li>
